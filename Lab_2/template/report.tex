...
\title{\textbf{Laboratorio} \\ Procesamiento de Imágenes}
...
\input{mainmatter/introduccion_ses_2}
\input{Lab_2/template/mainmatter/apartado_a}
\input{Lab_2/template/mainmatter/apartado_b}
\input{Lab_2/template/mainmatter/apartado_c}
