...
\input{Lab_Project/template/mainmatter/introduccion_proyecto}
\input{Lab_Project/template/mainmatter/materiales}
\input{Lab_Project/template/mainmatter/requisitos_tareas}
\input{Lab_Project/template/mainmatter/metodologia}
\input{Lab_Project/template/mainmatter/fechas_entregables}
\input{Lab_Project/template/mainmatter/calificacion}
\input{Lab_Project/template/mainmatter/primeros_pasos}
