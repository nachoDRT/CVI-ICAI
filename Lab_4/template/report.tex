...
\title{\textbf{Laboratorio} \\ Seguimiento de Objetos}
...
\input{mainmatter/introduccion_ses_3}
\input{Lab_4/template/mainmatter/apartado_a}
\input{Lab_4/template/mainmatter/apartado_b}
\input{Lab_4/template/mainmatter/apartado_c}
\input{Lab_4/template/mainmatter/apartado_d}
