...
\addcontentsline{toc}{section}{Tarea A.1: Cargar Imágenes}
...
\section*{Tarea A.4: Obtener Coordenadas 3D de las Esquinas del Patrón}
\addcontentsline{toc}{section}{Tarea A.4: Obtener Coordenadas 3D de las Esquinas del Patrón}
...
\addcontentsline{toc}{section}{Tarea A.6: Calibración de la Cámara Derecha}
